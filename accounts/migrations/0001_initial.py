# Generated by Django 4.1.7 on 2024-10-16 06:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pass_updated', models.DateTimeField(blank=True, default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp_for', models.CharField(choices=[('1', 'Login OTP'), ('2', 'Password Reset OTP'), ('3', 'Profile Email Change OTP'), ('4', 'Email Verify OTP')], max_length=1)),
                ('user', models.ForeignKey(limit_choices_to={'is_customer': True}, on_delete=django.db.models.deletion.CASCADE, related_name='cus_otp_set', to=settings.AUTH_USER_MODEL)),
            ],
            options={
